...
$sqli = "SELECT  serial_no FROM car WHERE Username =$user";

$query1 = $dbh -> prepare($sqli);;
$query1->execute();
...
?>
													...
													<div class="stat-panel-title text-uppercase">Pending Item</div>
												</div>
											</div>
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Approved Item</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Sold Car</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Interested</div>
												</div>
											</div>
